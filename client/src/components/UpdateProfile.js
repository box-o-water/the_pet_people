...
const [userFormData, setUserFormData] = useState({
  ...
  return (
    <>
    <p>Hey {userData?.me.username} What would you like to update about your profile!</p>
      ...
      <Form noValidate validated={validated} onSubmit={handleFormSubmit}>
        ...
        <Form.Group className="mb-3">
          <Form.Label htmlFor="location">Where are you looking to move to. (only city and state) </Form.Label>
          <Form.Control
            type="location"
            placeholder="Only City and state"
            name="location"
